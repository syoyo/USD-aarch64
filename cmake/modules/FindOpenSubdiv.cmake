...
message(STATUS "OSDROOT:" ${OPENSUBDIV_ROOT_DIR})

IF (ANDROID)
  # Directly set paths.
  set(OPENSUBDIV_INCLUDE_DIR ${OPENSUBDIV_ROOT_DIR}/include)
  set(OPENSUBDIV_LIBRARIES ${OPENSUBDIV_ROOT_DIR}/lib/libosdCPU.so)
  set(OPENSUBDIV_OSDCPU_LIBRARY ${OPENSUBDIV_ROOT_DIR}/lib/libosdCPU.so)
ELSE()
